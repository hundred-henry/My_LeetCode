...
- If $$nums[0]=0$$ and $0$ is NOT in the flip sequence, $$nums[0]=0$$ remains $0$ in the final result.
- If $$nums[0]=1$$ and $0$ is in the flip sequence, $$nums[0]=0$$ becomes $0$ in the final result.
...
- If $$nums[0]=1$$, then `i` must NOT be in the sequence, and we do not flip $$nums[0],nums[1],…,nums[K−1]$$.
